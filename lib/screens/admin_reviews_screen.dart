...
class _AdminReviewsScreenState extends State<AdminReviewsScreen> {
  ...
  final List<ReviewItem> reviews = [
    ...
    ReviewItem(
      ...
      rating: 4,
      review:
          'Very beautiful cake and good taste. Everyone loved it.',
      date: 'Yesterday',
    ),
    ReviewItem(
      name: 'Usman Ali',
    ...
    ReviewItem(
      ...
      rating: 3,
      review:
          'Cake was good but delivery was a little late.',
      date: '3 days ago',
    ),
    ReviewItem(
      name: 'Hassan Raza',
      ...
      rating: 5,
      review:
          'Perfect taste and beautiful presentation. Highly recommended.',
      date: '5 days ago',
    ),
  ];
  ...
  List<ReviewItem> get filteredReviews {
    ...
    return reviews.where((review) {
      ...
      final matchesFilter =
          selectedFilter == 'All' ||
              review.rating.toString() == selectedFilter;
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration:
                InputDecoration(
              hintText:
                  'Search customer, cake or review...',
  ...
  Widget _buildReviewsSection(
    ...
    final List<ReviewItem> filtered =
        filteredReviews;
